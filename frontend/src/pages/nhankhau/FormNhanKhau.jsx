...
// import moment from 'moment' // Bạn có vẻ không dùng moment trong đoạn render, có thể bỏ nếu muốn gọn
import './FormS.css'
...
const FormS = ({ data, close, setList, table }) => {
  ...
  const checkQuanHe = (quanHeWithDau) => {
    ...
    const quanHeDauArray = [
      'con', 'cháu', 'chắt', 'vợ', 'chồng', 'ông', 'bà', 'cụ', 'kị',
      'em', 'anh', 'chủ hộ','cha','me','cau','mo',
    ...
    for (let i = 0; i < quanHeDauArray.length; i++) {
      ...
      if (
        quanHeKhongDau.includes(
          quanHeDau.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '')
        )
      ) {
        return true;
      }
  ...
  const schema = yup.object().shape({
    ...
    .matches(/^\d{4}-\d{2}-\d{2}$/, 'Ngày tháng năm phải có định dạng yyyy-mm-dd ')
    ...
    sdt: yup.string().matches(/^0\d{9}$/, "Số điện thoại phải bắt đầu bằng số 0 và có 10 chữ số").nullable(),
    cccd: yup.string().nullable().matches(/^\d{12}$/, 'Căn cước công dân phải là một chuỗi 12 chữ số'),
    ...
    ngaychuyenden: yup.string().nullable()
      .matches(/^\d{4}-\d{2}-\d{2}$/, 'Ngày phải có định dạng yyyy-mm-dd (ví dụ: 2000-02-20)')
      .test('valid-date', 'Ngày không hợp lệ', function (value) {
        if (!value) return true;
        const [year, month, day] = value.split('-');
        const isValidDate = !isNaN(Date.parse(`${month}/${day}/${year}`));
  ...
  const onSubmitForm =  async (values) => {
    ...
    try {
        ...
        // Nếu không rơi vào các case trên
        alert(response?.data?.message || 'Có lỗi xảy ra hoặc phản hồi không xác định');
  ...
  // Đảm bảo vaitro có giá trị mặc định nếu data chưa có
  const initialValues = {
    ...data,
    vaitro: data.vaitro || 'Công dân' 
  }
        ...
        <Form noValidate onSubmit={handleSubmit} className="w-75 d-flex flex-column justify-content-center">
          ...
          <Row>
            <Form.Group className="position-relative mb-3">
              ...
              <Form.Control name="hoten" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.hoten} isValid={touched.hoten && !errors.hoten} isInvalid={touched.hoten && !!errors.hoten} />
          ...
          <Row>
            <Form.Group className="position-relative mb-3">
              ...
              <Form.Control name="bietdanh" type="text" onBlur={handleBlur} onChange={handleChange} value={values.bietdanh} isValid={touched.bietdanh && !errors.bietdanh} isInvalid={touched.bietdanh && !!errors.bietdanh} />
              <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Row>
            ...
            <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="ngaysinh" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.ngaysinh} isValid={touched.ngaysinh && !errors.ngaysinh} isInvalid={touched.ngaysinh && !!errors.ngaysinh} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Row>
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Select name='gioitinh' aria-label="select example" onChange={handleChange} value={values.gioitinh} >
          ...
          <Row>
            <Form.Group className="position-relative mb-3">
              ...
              <Form.Control name="noisinh" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.noisinh} isValid={touched.noisinh && !errors.noisinh} isInvalid={touched.noisinh && !!errors.noisinh} />
              <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Row>
            <Form.Group className="position-relative mb-3">
              ...
              <Form.Control name="nguyenquan" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.nguyenquan} isValid={touched.nguyenquan && !errors.nguyenquan} isInvalid={touched.nguyenquan && !!errors.nguyenquan} />
              <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Row>
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="diachi" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.diachi} isValid={touched.diachi && !errors.diachi} isInvalid={touched.diachi && !!errors.diachi} disabled = {mode === themnhankhau} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
            ...
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="dantoc" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.dantoc} isValid={touched.dantoc && !errors.dantoc} isInvalid={touched.dantoc && !!errors.dantoc} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
            ...
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="tongiao" type="text" onBlur={handleBlur} onChange={handleChange} value={values.tongiao} isValid={touched.tongiao && !errors.tongiao} isInvalid={touched.tongiao && !!errors.tongiao} />
              </Form.Group>
            </Col>
          </Row>
          ...
          <Row>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="quoctich" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.quoctich} isValid={touched.quoctich && !errors.quoctich} isInvalid={touched.quoctich && !!errors.quoctich} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Row>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="hochieu" type="text" onBlur={handleBlur} onChange={handleChange} value={values.hochieu} isValid={touched.hochieu && !errors.hochieu} isInvalid={touched.hochieu && !!errors.hochieu} />
              </Form.Group>
          </Row>
          ...
          <Row>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="nghenghiep" type="text" onBlur={handleBlur} onChange={handleChange} value={values.nghenghiep} isValid={touched.nghenghiep && !errors.nghenghiep} isInvalid={touched.nghenghiep && !!errors.nghenghiep} />
              </Form.Group>
          </Row>
          ...
          <Row>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="noilamviec" type="text" onBlur={handleBlur} onChange={handleChange} value={values.noilamviec} isValid={touched.noilamviec && !errors.noilamviec} isInvalid={touched.noilamviec && !!errors.noilamviec} />
              </Form.Group>
          </Row>
          ...
          <Row>
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="sdt" type="text" onBlur={handleBlur} onChange={handleChange} value={values.sdt} isValid={touched.sdt && !errors.sdt} isInvalid={touched.sdt && !!errors.sdt} />
            ...
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="email" type="email" onBlur={handleBlur} onChange={handleChange} value={values.email} isValid={touched.email && !errors.email} isInvalid={touched.email && !!errors.email} />
          ...
          <Row>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="cccd" type="text" onBlur={handleBlur} onChange={handleChange} value={values.cccd} isValid={touched.cccd && !errors.cccd} isInvalid={touched.cccd && !!errors.cccd} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="ngaycap" type="text" onBlur={handleBlur} onChange={handleChange} value={values.ngaycap} isValid={touched.ngaycap && !errors.ngaycap} isInvalid={touched.ngaycap && !!errors.ngaycap} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
          ...
          <Row>
            <Form.Group className="position-relative mb-3">
              ...
              <Form.Control name="noicap" type="text" onBlur={handleBlur} onChange={handleChange} value={values.noicap} isValid={touched.noicap && !errors.noicap} isInvalid={touched.noicap && !!errors.noicap} />
            </Form.Group>
          </Row>
          ...
          <Row>
            <Form.Group className="position-relative mb-3">
              ...
              <Form.Control name="noithuongtrutruoc" type="text" onBlur={handleBlur} onChange={handleChange} value={values.noithuongtrutruoc} isValid={touched.noithuongtrutruoc && !errors.noithuongtrutruoc} isInvalid={touched.noithuongtrutruoc && !!errors.noithuongtrutruoc} />
            </Form.Group>
          </Row>
          ...
          <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="ngaychuyenden" type="text" onBlur={handleBlur} onChange={handleChange} value={values.ngaychuyenden} isValid={touched.ngaychuyenden && !errors.ngaychuyenden} isInvalid={touched.ngaychuyenden && !!errors.ngaychuyenden} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
                <Form.Control.Feedback className="top-0 end-0" type="invalid" tooltip>{errors.ngaychuyenden}</Form.Control.Feedback>
              </Form.Group>
          </Row>

          {/* --- CẬP NHẬT PHẦN CUỐI CÙNG Ở ĐÂY ĐỂ THÊM VAI TRÒ --- */}
          <Row>
            <Col>
              <Form.Group className="position-relative mb-3">
                <Form.Label>Mã hộ khẩu</Form.Label>
                <Form.Control name="mahokhau" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.mahokhau} isValid={touched.mahokhau && !errors.mahokhau} isInvalid={touched.mahokhau && !!errors.mahokhau} disabled= {true} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
            ...
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Control name="quanhe" required type="text" onBlur={handleBlur} onChange={handleChange} value={values.quanhe} isValid={touched.quanhe && !errors.quanhe} isInvalid={touched.quanhe && !!errors.quanhe} disabled = {mode === themhokhau||(mode===suanhankhau&&values.quanhe==="Chủ hộ")} />
                <Form.Control.Feedback className="top-0 end-0" type="valid" tooltip>Good!</Form.Control.Feedback>
                <Form.Control.Feedback className="top-0 end-0" type="invalid" tooltip>{errors.quanhe}</Form.Control.Feedback>
              </Form.Group>
            </Col>
            
            {/* THÊM CỘT VAI TRÒ Ở ĐÂY */}
            <Col>
              <Form.Group className="position-relative mb-3">
                ...
                <Form.Select 
                  ...
                  onBlur={handleBlur}
                  value={values.vaitro} 
                  isValid={touched.vaitro && !errors.vaitro} 
                  isInvalid={touched.vaitro && !!errors.vaitro}
                >
                  <option value="Công dân">Công dân</option>
                  <option value="Tổ trưởng dân phố">Tổ trưởng dân phố</option>
                  <option value="Bí thư chi bộ">Bí thư chi bộ</option>
                  <option value="Cảnh sát khu vực">Cảnh sát khu vực</option>
                  <option value="Khác">Khác</option>
                </Form.Select>
                <Form.Control.Feedback className="top-0 end-0" type="invalid" tooltip>{errors.vaitro}</Form.Control.Feedback>
              </Form.Group>
            </Col>
          </Row>
